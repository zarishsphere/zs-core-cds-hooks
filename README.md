...
CDS Hooks 2.0 service — clinical decision support integration
...
git clone https://github.com/zarishsphere/zs-core-cds-hooks.git
cd zs-core-cds-hooks
...
See [docs.zarishsphere.com/api/zs-core-cds-hooks](https://docs.zarishsphere.com/api/zs-core-cds-hooks) for the full OpenAPI 3.1 specification.
